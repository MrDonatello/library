...
class BookEdit extends Component {
    ...
    async handleSubmit(event) {
        ...
        await fetch('/library/book' + (item.id ? '/' + item.id : ''), {
            ...
            <Container>
                ...
                <Form onSubmit={this.handleSubmit}>
                    ...
                    <FormGroup>
                        ...
                        < Input type="text" name="yearOfPublishing" id="yearOfPublishing" value={item.yearOfPublishing}
                                onChange={this.handleChange} autoComplete="yearOfPublishing"/>
                    </FormGroup>
                    <FormGroup>
